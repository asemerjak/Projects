import pytest
from app import hello, extract_sentiment, text_contain_word, bubble
...
def test_extract_sentiment_param(sample):
...
@pytest.mark.parametrize('tab, expected_output', testdata_bubble)
def test_bubble(tab, expected_output):

    assert bubble(tab) == expected_output